game:GetService("StarterGui"):SetCore("SendNotification",{Title = "皮脚本",Text = "欢迎使用皮脚本",Icon = "rbxassetid://18941716391",Duration = 1,Callback = bindable,Button1 = "皮脚本功能多多",Button2 = "整合脚本"})
 wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "皮脚本",Text = "脚本正在加载中",Icon = "rbxassetid://18941716391",Duration = 1,Callback = bindable,Button1 = "希望使用皮脚本的人能越来越多",Button2 = "皮脚本期待您的使用"})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "皮脚本",Text = "加载成功，祝您使用愉快",Icon = "rbxassetid://18941716391",Duration = 2,Callback = bindable,Button1 = "有时间就会更新脚本",Button2 = "祝您使用愉快"})
