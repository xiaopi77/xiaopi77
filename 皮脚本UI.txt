...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://rbxassetid://18930445827"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://18930445827" or "rbxassetid://18930445827" --开关的图
end)
...
------------------------------------------------------AL.King音乐-------------------------------------------------------
    ...
    sound.SoundId = "rbxassetid://18131304931" --音乐id
...
if theme == 'dark' then
    ...
    coroutine.wrap(NPLHKB_fake_script)()
      ...
      Open.BorderColor3 = Color3.fromRGB(0, 0, 0)
      Open.Image = 'rbxassetid://18930445827'
      Open.Active = true
      Open.Draggable = true
      Open.MouseButton1Click:Connect(function()
      Main.Visible = not Main.Visible
